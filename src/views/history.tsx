...
const Main = styled.main`
  ...
  .history.light .return path {
    stroke: black;
  }
  
  .history.light h1, .history.light p{
    color: black;
  }
  
  .history.light .history-element {
    background: white;
    
  }

  .history.light .history-element .image-container {
    background: white;
  }

  .history.light .history-element .btn-heart  path{
    fill: #2067f8;
  }

  .history.light section {
    background-color: white;
    transition: all 0.5s ease-in-out;
  }
  
  .history.light section .history-nav,
  .history.light section .logout:hover,
  .history.light section .home-nav:hover{
    background-color: #e5e5e5;
  }
      
  .history.light section .logout:hover path,
  .history.light section .history-nav path,
  .history.light section .home-nav:hover path{
    fill: #1A5BE1;
  }
`;
